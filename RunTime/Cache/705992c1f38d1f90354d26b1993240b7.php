                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">团模板id</th>
                                                    <th class="text-center">中奖用户</th>
                                                    <th class="text-center">本团发放金额(元)</th>
                                                    <th class="text-center">参团新用户百分点</th>
                                                    <th class="text-center">实际新用户人数</th>
                                                    <th class="text-center">实际拉新成本</th>
                                                    <th class="text-center">新用户中奖人数</th>
                                                    <th class="text-center">发放状态</th>
                                                    <th class="text-center">发放日志</th>
                                                ...
                                                <tbody id="list_order_tby">
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                        ...
                                                        <td><?php echo ($val["groupbuyinst"]); ?></td>
                                                        <td><?php echo ($val["groubuytml"]); ?></td>
                                                        <td><div style="width:80px; height:60px; overflow: hidden;"><?php echo ($val["luck_uids"]); ?></div></td>
                                                        <td><?php echo ($val["total_money"]); ?></td>
                                                        <td><?php echo ($val["new_user_ratio"]); ?></td>
                                                        <td><?php echo ($val["real_group_new_user_num"]); ?></td>
                                                        <td><?php echo ($val["real_one_money"]); ?></td>
                                                        <td><?php echo ($val["real_luck_new_user_num"]); ?></td>
