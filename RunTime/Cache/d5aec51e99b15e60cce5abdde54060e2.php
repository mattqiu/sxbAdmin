                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-3">
                                    <span class="label">团购id：<?php echo ($item["id"]); ?></span>
                                </div>
                                <div class="form-group col-xs-5">
                                    <span class="label">团购名:<?php echo ($item["groupbuying_name"]); ?></span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="form-group col-xs-12">
                                    <span class="label">单独购买价格:<?php echo ($item["separatebuy_price"]); ?></span>
                                    <div class="form-group col-xs-3">
                                        <span class="label">团购价格:<?php echo ($item["groupbuying_price"]); ?></span>
                                    </div>
                                    <div class="form-group col-xs-3">
                                        <span class="label">成团人数:<?php echo ($item["groupbuying_reqnums"]); ?></span>
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <span class="label">差<?php echo ($item['groupbuying_reqnums']-$item['groupbuying_nownums']); ?>人，增加机器人几人:</span>
