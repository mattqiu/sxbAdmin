...
<div id="nav-col">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select  id="groupbuy_time_type" class="form-control" >
                                    <option value="0" <?php if($get["timetype"] == 0): ?>selected<?php endif; ?> >按开团时间查询</option>
                                    <option value="1" <?php if($get["timetype"] == 1): ?>selected<?php endif; ?> >按结束时间查询</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="datepickerDateRange" class="form-control" value="<?php echo ($get["choosetime"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-1" >
                                    ...
                                    <input type="text" id="tmp_id" name="tmp_id" class="form-control w150 form-inline-input-group" value="<?php echo ($get["tmp_id"]); ?>" />
                                </div>
    ...
    <td><?php echo ($item["groupbuying_endtime"]); ?></td>
    <td>
        <a href="/index.php?m=GroupBuying&a=pingtuan&id=<?php echo ($item["id"]); ?>">给它拼团</a>
    </td>
