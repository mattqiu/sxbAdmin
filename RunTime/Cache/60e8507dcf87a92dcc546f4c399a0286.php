...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>评论模板管理</span></li>
                                </ol>
                                <h1>评论模板</h1>
                            </div>
                        </div>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/Comment/addtml" class="btn btn-primary mrg-b-lg">新增模板</a>
                                        </div>
                                    </header>
    ...
    <td>
        <a href="/index.php?m=Comment&a=edittml&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Comment&a=deltml&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
