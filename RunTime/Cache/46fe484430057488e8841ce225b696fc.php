...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>宝盒模板管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/<?php echo (MODULE_NAME); ?>/add" class="btn btn-primary mrg-b-lg">添加模板</a>
                                        </div>
                                    </header>
    ...
    <td>
        <a href="/<?php echo (MODULE_NAME); ?>/edit/id/<?php echo ($item["id"]); ?>">编辑</a>
