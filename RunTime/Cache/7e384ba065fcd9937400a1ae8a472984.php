        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=user&a=saveedituser"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户id（机器人定义1-10000）:</span>
                                    <input id="id" type="text" value="<?php echo ($item["id"]); ?>" name="id" class="form-control col-xs-6"/>
                                </div>

                                <div class="form-group col-xs-5">
                                    <span class="label">用户名:</span><input id="username" type="text" value="<?php echo ($item["username"]); ?>" name="username" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="password" id="password" value="<?php echo ($item["password"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">手机:</span>
                                    <input type="text" name="mobile" id="mobile" value="<?php echo ($item["mobile"]); ?>" class="form-control col-xs-3"/>
                                </div>
                                <div class="form-group col-xs-5">
                                    <span class="label">性别:</span>
                                    <input type="text" name="sex" id="sex" value="<?php echo ($item["sex"]); ?>" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">头像id:</span>
                                    <input type="text" name="user_head" id="user_head" value="<?php echo ($item["user_head"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
