            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">O2O团购模板编辑</h4>
                    </div>
                    <form action="/index.php?m=Ogrouptml&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">成团所需金额：</span>
                                    <input id="o2o_money" type="text" placeholder="请输入成团金额 例：100" value="<?php echo ($result["o2o_money"]); ?>" name="o2o_money" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">成团所需人数：</span>
                                    <input type="text" name="o2o_nums" id="o2o_nums" placeholder="请输入成团人数 例：5" value="<?php echo ($result["o2o_nums"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">成团所需条件：</span>
                                    <label><input type="radio" name="condition" value="1" <?php if($result["condition"] == 1): ?>checked<?php endif; ?> >金额 or 人数</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label><input type="radio" name="condition" value="2" <?php if($result["condition"] == 2): ?>checked<?php endif; ?> >金额 and 人数</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">成团配送时间：</span>
                                    <input type="text" name="delivery_time" value="<?php echo ($result["delivery_time"]); ?>" id="delivery_time" placeholder="请输入配送时间 例：15:30"  class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">所需成团时间：</span>
                                    <input type="text" name="group_ok_time" value="<?php echo ($result["group_ok_time"]); ?>" id="group_ok_time" placeholder="需在配送时间前成团 例：15:30" class="form-control col-xs-5"/>
                                </div>
                            </div>
