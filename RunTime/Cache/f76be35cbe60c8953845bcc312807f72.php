                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>用户亲密度查看</span></li>
                                </ol>
                                    ...
                                    <div class="main-box-body clearfix" style="margin-top:30px;">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                <thead>
                                                <tr>
                                                    <th class="text-center">发起总量</th>
                                                    <th class="text-center">发起者ID</th>
                                                ...
                                                <tbody id="list_order_tby">
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo ($val["sponsor_id"]); ?></td>
                                                            <td>
                                                                <a href="/index.php?m=Groupcode&a=edit&id={val.sponsor_id}">查看</a>
                                                            </td>
