                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/order" method="post" target="_self" role="form" id="order_search_form">
                                            ...
                                            <div class="row">
                                                ...
                                                <!--<div class="form-group col-md-4" >-->
                                                    <!--<label for="place" class="form-inline-label">选择地点：</label>-->
                                                    <!--<select  id="prov" class="form-control w100 text-center form-inline-input-group" name="prov">-->
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                <tbody id="list_order_tby">
                                                    <tr>
                                                        <th class="text-idt">有效订单总量：&nbsp;<span class="green"><?php echo ($totle['totle']); ?></span>&nbsp;单</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-idt">订单总金额数：&nbsp;<span class="green"><?php echo ($totle['money']); ?></span>&nbsp;元</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-idt">平均每单价格：&nbsp;<span class="red"><?php echo ($avg); ?></span>&nbsp;元</th>
                                                    </tr>
...
<script>
    $(function($){
//         $.ajax({
//            url : "<?php echo U('DataReport/areaList');?>",
//            data : {pid:0},
//            type : 'post',
//            async : false,
