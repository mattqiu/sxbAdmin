                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/goods" method="post" target="_self" role="form" id="order_search_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    ...
                                                    <select  id="site" class="form-control w150 text-center form-inline-input-group" name="site">
                                                            <option value="1" <?php if($post["site"] == 1): ?>selected<?php endif; ?>>------所有------</option>
                                                            <option value="2" <?php if($post["site"] == 2): ?>selected<?php endif; ?>>------嘉善------</option>
                                                    </select>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    <label for="sort" class="form-inline-label">排序方式：</label>
                                                    <select  id="sort" class="form-control w150 text-center form-inline-input-group" name="sort">
                                                            <option value="0" <?php if($post["sort"] == 0): ?>selected<?php endif; ?>>------请选择------</option>
                                                            <option value="1" <?php if($post["sort"] == 1): ?>selected<?php endif; ?>>----商品ID降序----</option>
                                                            <option value="2" <?php if($post["sort"] == 2): ?>selected<?php endif; ?>>----商品ID升序----</option>
                                                            <option value="3" <?php if($post["sort"] == 3): ?>selected<?php endif; ?>>----订单升序-----</option>
                                                            <option value="4" <?php if($post["sort"] == 4): ?>selected<?php endif; ?>>----订单降序----</option>
                                                            <option value="5" <?php if($post["sort"] == 5): ?>selected<?php endif; ?>>----总金额升序----</option>
                                                            <option value="6" <?php if($post["sort"] == 6): ?>selected<?php endif; ?>>----总金额降序----</option>
                                                    </select>
                                                </div>
                                            ...
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tbody class="tbo">
                                                    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo ($vol["sqty"]); ?>&nbsp;单</td>
                                                            <td><?php echo (round($vol["stm"],2)); ?>&nbsp;元</td>
                                                            <td><?php echo ($vol["avg"]); ?>&nbsp;元</td>
...
//      $('.up').click(function(){
//          var _this = $(this);
//          var types = _this.attr('type');
//          $.ajax({
//              url : "/<?php echo (MODULE_NAME); ?>/goods",
//              data : 'type='+types,
//              type : 'post',
