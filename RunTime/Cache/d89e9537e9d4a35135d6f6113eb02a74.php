            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">商户实例修改</h4>
                    </div>
                    <form action="/index.php?m=Omerchantmsg&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户经度：</span>
                                    <input  type="text" name="longitade" value="<?php echo ($result["longitade"]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">商户纬度：</span>
                                    <input type="text" name="lat" value="<?php echo ($result["lat"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <!--<div class="row">-->
                                <!--<div class="form-group col-xs-10">-->
                                    <!--<span class="label">商户选择：</span>-->
                                    <!--<select  class="form-control col-xs-2 text-center form-inline-input-group" name="o2o_id">-->
                                        <!--<option value="">请选择</option>-->
                                        <!--<?php if(is_array($merchant)): foreach($merchant as $key=>$vo): ?>-->
                                            <!--<option value="<?php echo ($vo["id"]); ?>" <?php if($result['o2o_id'] == $vo['id']): ?>selected<?php endif; ?>> <?php echo ($vo["o2o_name"]); ?></option>-->
                            ...
                            <!--<div class="row">-->
                                <!--<div class="form-group col-xs-10">-->
                                    <!--<span class="label">配送次数：</span>-->
                                    <!--<input type="text" name="distribution_time_id" value="<?php echo ($result["distribution_time_id"]); ?>"  class="form-control col-xs-5"/>-->
                                <!--</div>-->
                            <!--</div>-->
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">配送时间：</span>
                                        <?php if(is_array($timeList)): foreach($timeList as $key=>$vo): ?><label>
                                                <input type="checkbox" name="o2o_time_list[]" value="<?php echo ($vo["id"]); ?>"> <?php echo ($vo["delivery_time"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
