                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <form action="/<?php echo (MODULE_NAME); ?>/dynamicUser" method="post" target="_self" role="form" id="search_form">
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">初次下单时间</th>
                                                ...
                                                <tbody id="list_order_tby">
                                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                                                            ...
                                                            <td class="text-center"><?php echo ($val["groupbuying_name"]); ?></td>
                                                            <td class="text-center"><?php echo ($val["recv_address"]); ?></td>
                                                            <td class="text-center"><?php echo ($val["order_num"]); ?></td>
                                                            <td class="text-center"><?php echo ($val["first_order_time"]); ?></td>
