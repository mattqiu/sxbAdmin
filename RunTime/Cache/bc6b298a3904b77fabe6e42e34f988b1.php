                            ...
                            <div id="jquery_photo_list" class="photo_list">
                                <ul class="plist-ul">
                                    <?php if(is_array($list)): foreach($list as $key=>$item): ?><li>
                                            <img src="<?php echo ($img_site); echo ($item["thum_photo"]); ?>" alt="" width="100" height="100"> <br>
                                            <input onblur="jquery_photo_list_update(<?php echo ($item["product_id"]); ?>,<?php echo ($item["id"]); ?>,this.value)" value="<?php echo ($item["order_id"]); ?>" size="5" type="text">
                                            <a href="javascript:jquery_photo_list_del(<?php echo ($item["product_id"]); ?>,<?php echo ($item["id"]); ?>)">删除</a>
                                        </li><?php endforeach; endif; ?>
                                </ul>
