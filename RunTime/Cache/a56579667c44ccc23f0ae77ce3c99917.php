            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">添加发货仓</h4>
                    </div>
                    <form action="/Sendwarehome/doCreate"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-4" style="margin-right:30000px;">
                                    <span class="label">发货仓名</span>
                                    <input type="text" name="name" class="form-control col-xs-6" id="name"/>
                                </div>
                                <div class="form-group col-xs-4" style="margin-right:30000px;">
                                    <span class="label">发货仓号</span>
                                    <input type="text" name="jd_warehome_code" class="form-control col-xs-6"/>
                                </div>
                                <div class="form-group col-xs-4" style="margin-right:30000px;">
                                    <span class="label">字母名称</span>
                                    <input type="text" name="en_name" class="form-control col-xs-6" />
                                </div>
                                <div class="form-group col-xs-4">
                                    <span class="label">始发城市</span>
                                    <input type="text" name="source_city" class="form-control col-xs-6" />
                                </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">发货渠道id</span>
                                    <a href="javascript:void(0);" id="select_supply_id" class="modals_radio_select md-trigger btn btn-primary"
                                       data-inputId="supply_id" data-url="/Sendwarehome/selectJson"
                                       data-title="选择发货渠道" data-modal="modal_radio_select">选择发货渠道id</a>
                                    <input type="text" name="supply_id" class="form-control col-xs-2 modals_radio_select_input" id="supply_id"style="width:136px;"/>
                                </div>
                            </div>
