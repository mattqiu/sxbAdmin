                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <input id="id" type="text" value="<?php echo ($item["id"]); ?>" name="id" class="form-control col-xs-6"/>
                                </div>

                                <div class="form-group col-xs-5">
                                    <span class="label">父级id:</span>
                                    <input id="parent_id" type="text" value="<?php echo ($item["pid"]); ?>" name="parent_id" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">名称:</span><input id="name" type="text" value="<?php echo ($item["name"]); ?>" name="name" class="form-control col-xs-6"/>
                                </div>
                                <div class="form-group col-xs-3">
                                    <span class="label">邮编:</span>
                                    <input type="text" name="zipcode" id="zipcode" value="<?php echo ($item["zipcode"]); ?>" class="form-control col-xs-6"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">首重:</span>
                                    <input type="text" name="first_weight" id="first_weight" value="<?php echo ($item["first_weight"]); ?>" class="form-control col-xs-6"/>
                                </div>

                                <div class="form-group col-xs-3">
                                    <span class="label">首重价格:</span><input type="text" name="first_weight_price" id="first_weight_price" class="form-control col-xs-8" value="<?php echo ($item["first_weight_money"]); ?>"/>
                                </div>
                                <div class="form-group col-xs-3">
                                    <span class="label">续重价格:</span>
                                    <input type="text" name="follow_weight_money" id="follow_weight_money" class="form-control col-xs-8" value="<?php echo ($item["follow_weight_money"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <select name="active" id="active">
                                        <option value="0" <?php if($item["active"] == 0): ?>selected="selected"<?php endif; ?> >不开通</option>
                                        <option value="1" <?php if($item["active"] == 1): ?>selected="selected"<?php endif; ?> >开通</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="sendwarehome_data" class="row" add_line="<?php echo ($count - 1); ?>">
                                <?php if(is_array($send_warehomes)): foreach($send_warehomes as $key=>$value): ?><div id="dev_sendwarehome_id_<?php echo ($key); ?>" class="row sendwarehome_line">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input type="text" name="sendwarehome_postage[]" class="form-control col-xs-1 modals_radio_select_input" id="sendwarehome_postage_<?php echo ($key); ?>" value="<?php echo ($value['warehome_postage']); ?>"/>
                                            <span class="">优先级</span>
                                            <input type="text" name="sendwarehome_index[]" class="form-control col-xs-1 modals_radio_select_input" value="<?php echo ($key); ?>"/>
