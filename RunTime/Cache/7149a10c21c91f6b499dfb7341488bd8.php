        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Node&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">节点名:</span>
                                    <input id="username" type="text" placeholder="请输入节点名" name="name" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="mname" id="username" placeholder="请输入控制器名" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">操<span style="color:#fff">做</span>作:</span>
                                    <input type="text" name="aname" id="username" placeholder="请输入方法名" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label stt">状<span style="color:#fff">做</span>态:</span>
                            ...
                            <div class="modal-footer">
                                <button id="form_save" class="btn btn-primary" style="float:left;">保存</button>
                            </div>
                        </div>
                    </form>
                </div>
