...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>宝盒查询</span></li>
                                </ol>
    ...
    <td ><?php echo ($item["need_key_num"]); ?></td>
    <td ><?php echo ($item["drop_group_id"]); ?></td>
    <td ><?php echo ($item["lifetime"]); ?>(天)</td>
    <td ><?php echo ($item["uid"]); ?></td>
    <td ><?php echo ($item["send_time"]); ?></td>
    <td ><?php echo ($item["use_state"]); ?></td>
    <td ><?php echo ($item["description"]); ?></td>
    <td ><?php echo ($item["sms_send_showtext"]); ?></td>
    <td ><?php echo ($item["sms_send_type"]); ?></td>
