...
<div id="nav-col">
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/Postage/add/parent_id/0" class="btn btn-primary mrg-b-lg">新增地址</a>
                                        </div>
                                    </header>
    ...
    <td ><a href="/postage/area/id/<?php echo ($item["id"]); ?>/provincename/<?php echo ($item["name"]); ?>"> <?php echo ($item["name"]); ?></a></td>
    <td ><?php echo ($item["zipcode"]); ?></td>
    <td><?php echo ($item["active"]); ?></td>
    <td>
        <?php if(is_array($item["send_warehome"])): foreach($item["send_warehome"] as $key=>$value): ?><div>
                <?php echo ($value); ?>
