            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">二维码信息编辑</h4>
                    </div>
                    <form action="/index.php?m=Groupcode&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">图片地址:</span>
                                    <input id="img" type="text" name="img" value="<?php echo ($data["img"]); ?>" class="form-control col-xs-4 "/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label stt">状&nbsp;&nbsp;&nbsp;态:</span>
                                    <label> <input type="radio" name="status" value="1" <?php if($data["status"] == 1): ?>checked<?php endif; ?>>&nbsp;未使用</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label> <input type="radio" name="status" value="0" <?php if($data["status"] == 2): ?>checked<?php endif; ?>>&nbsp;已使用</label>
                                </div>
                            </div>

                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">群内人数:</span>
                                    <input type="text" name="group_num" id="group_num"  value="<?php echo ($data["group_num"]); ?>" class="form-control col-xs-2"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">团实例ID:</span>
                                    <input type="text" name="groupbuying_id" id="groupbuying_id"  value="<?php echo ($data["groupbuying_id"]); ?>" class="form-control col-xs-2" disabled/>
                                </div>
                            </div>

                            <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                            <div class="modal-footer">
                                <button id="form_save" class="btn btn-primary" style="float:left;">确认修改</button>
                            </div>
                        </div>
                    </form>
                </div>
