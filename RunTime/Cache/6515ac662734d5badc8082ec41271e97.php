...
<div id="nav-col">
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/Product/edit" class="md-trigger btn btn-primary mrg-b-lg">新建商品</a>
                                        </div>
                                    </header>
    ...
    <td >
        <?php if(is_array($item["product_price"])): foreach($item["product_price"] as $key=>$price): echo ($price["volume"]); ?> ￥<?php echo ($price["price"]); ?>元/<?php echo ($price["unit"]); ?> <br/><?php endforeach; endif; ?>
    </td>
    <td ><?php echo ($item["promo_code"]); ?><br><?php echo ($item["discount"]); ?>折<br><?php echo ($item["period"]); ?></td>
    <td ><?php echo ($item["viewed"]); ?></td>
    <td ><?php echo ($item["sales"]); ?></td>
    <td ><a href="/Product/photos/id/<?php echo ($item["id"]); ?>">商品相册</a></td>
    <td ><?php echo ($item["order_id"]); ?></td>
    <td>
        <a href="<?php echo ($frontSiteUrl); ?>/detail/index/<?php echo ($item["id"]); ?>" target="_blank">预览</a>
        <a href="/Product/copy/id/<?php echo ($item["id"]); ?>" target="_blank">复制</a>
        <a href="/Product/edit/id/<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/Product/del/id/<?php echo ($item["id"]); ?>">删除</a>
    </td>
