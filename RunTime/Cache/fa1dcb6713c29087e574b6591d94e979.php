        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Role&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">角色名称:</span>
                                    <input id="username" type="text" placeholder="请输入角色名称" name="name" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="remark" id="username" placeholder="请输入角色描述" class="form-control col-xs-5"/>
                                </div>
                            </div>
