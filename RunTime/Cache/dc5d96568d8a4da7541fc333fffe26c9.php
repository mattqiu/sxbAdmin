        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Admin&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户名称:</span>
                                    <input id="username" type="text" placeholder="请输入用户名" name="admin_name" value="<?php echo ($vo["admin_name"]); ?>" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="nickname" id="username" placeholder="请输入用户昵称" value="<?php echo ($vo["nickname"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户密码:</span>
                                    <input type="password" name="password" id="username" placeholder="请输入密码" value="<?php echo ($vo["password"]); ?>" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label stt">状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态:</span>
                                    <label> <input type="radio" name="status" value="1" <?php if($vo["status"] == 1): ?>checked<?php endif; ?>>&nbsp;启用</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label> <input type="radio" name="status" value="0" <?php if($vo["status"] == 0): ?>checked<?php endif; ?>>&nbsp;禁用</label>
                                </div>
                            </div>
