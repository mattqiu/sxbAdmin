                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>群二维码管理</span></li>
                                </ol>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-center">二维码ID</th>
                                                    <th class="text-center">二维码图片地址</th>
                                                    <th class="text-center">二维码状态</th>
                                                    <th class="text-center"><群内应有></群内应有>人数</th>
                                                    <th class="text-center">团实例ID</th>
                                                    <th class="text-center">图片添加时间</th>
                                                    <th class="text-center">群二维码过期时间</th>
                                                    <th class="text-center">群主微信号</th>
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
                                                        ...
                                                        <td ><img src="<?php echo ($item["img"]); ?>" alt="" style="width:80px;"></td>
                                                        <td > <?php if($item["status"] == 1): ?>未使用<?php else: ?>已使用<?php endif; ?> </td>
                                                        <td ><?php echo ($item["group_num"]); ?></td>
                                                        <td ><?php echo ($item["groupbuying_id"]); ?></td>
                                                        <td ><?php echo ($item["add_time"]); ?></td>
                                                        <td ><?php echo ($item["expir_time"]); ?></td>
                                                        <td ><?php echo ($item["wx_no"]); ?></td>
                                                        <td >
                                                            <a href="/index.php?m=Groupcode&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
                                                            <a href="/index.php?m=Groupcode&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
                                                        </td>
