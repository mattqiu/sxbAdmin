        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Omerchant&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户名称：</span>
                                    <input id="username" type="text" placeholder="请输入商户名" name="o2o_name" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5" >
                                    <label class="label">选择地点：</label>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="address" id="address" placeholder="请输入详细地址" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">商户电话：</span>
                                    <input type="text" name="phone" id="phone" placeholder="请输入商户电话" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button id="form_save" class="btn btn-primary" style="float:left;">添加</button>
                            </div>
                        </div>
                    </form>
                </div>
