...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>节点管理</span></li>
                                </ol>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">模块名(控制器)</th>
                                                    <th style="text-align:center;">操作(方法)</th>
    ...
    <td style="text-align:center;"><?php echo ($item["mname"]); ?></td>
    <td style="text-align:center;"><?php echo ($item["aname"]); ?></td>
    <td style="text-align:center;"><?php if($item["status"] == 1): ?>启用<?php else: ?>禁用<?php endif; ?></td>
    <td style="text-align:center;">
        <a href="/index.php?m=Node&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Node&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
