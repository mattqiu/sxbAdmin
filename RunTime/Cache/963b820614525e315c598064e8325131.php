                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户id:<?php echo ($userinfo["id"]); ?></span>
                                    <span class="label">用户名:<?php echo ($userinfo["username"]); ?></span>
                                    <span class="label">手机号:<?php echo ($userinfo["mobile"]); ?></span>
                                </div>
                            ...
                            <input type="hidden" value="<?php echo ($userinfo["mobile"]); ?>" name="usermobile" />
