                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <input type="text" name="drop_rate" class="form-control col-xs-5" id="drop_rate"/>
                                </div>
                                <div class="form-group col-xs-5">
                                    <span class="label">每用户掉落限制次数（超过则不给这个用户）</span>
                                    <input type="text" name="user_limit_times" class="form-control col-xs-2" id="user_limit_times" value="0"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">总掉落限制次数（用于控制总量）</span>
                                    <input type="text" name="count_limit_times" class="form-control col-xs-2" id="count_limit_times" value="0"/>
                                </div>
                            </div>
