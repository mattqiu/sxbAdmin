...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>优惠权限管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/<?php echo (MODULE_NAME); ?>/create" class="btn btn-primary mrg-b-lg">添加权限</a>
                                        </div>
                                    </header>
    ...
    <td ><?php echo ($item["permission_groupid"]); ?></td>
    <td ><?php echo ($item["permission_type"]); ?></td>
    <td ><?php echo ($item["permission_value"]); ?></td>
    <td ><?php echo ($item["description"]); ?></td>
    <td ><?php echo ($item["effect_range"]); ?></td>

    <td >
        <a href="/index.php?m=GroupbuyPermission&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=GroupbuyPermission&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
