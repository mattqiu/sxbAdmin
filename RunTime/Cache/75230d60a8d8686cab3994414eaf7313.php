            ...
            <div id="content-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="/<?php echo (MODULE_NAME); ?>/getgroupbuy_condition" method="post" target="_self" role="form"> 
                            <div class="row">
                                <div class="form-group col-md-2">
                                    <label for="groupbuy_time_type">查询时间</label>
                                    <select  id="groupbuy_time_type" class="form-control text-center" name="timetype">
                                        <option value="0" <?php if($timetype == 0): ?>selected<?php endif; ?> >按开团时间查询</option>
                                        <option value="1" <?php if($timetype == 1): ?>selected<?php endif; ?> >按结束时间查询</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-2" style="padding-top:25px;">
                                    <label for="datepickerDateFrom" class="form-inline-label" style="position:absolute;top:3px;">从：</label>
                                    <div class="input-group form-inline-input-group w135">
                                    ...
                                    <div class="input-group input-append bootstrap-timepicker" style="width: 120px; float: right;">
                                ...
                                <div class="form-group col-md-2 " style="padding-top:25px;">
                                    <label for="datepickerDateTo" class="form-inline-label" style="position:absolute;top:3px;">到：</label>
                                    <div class="input-group form-inline-input-group w135">
                                        <span class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <select  id="groupbuy_status_sel" class="form-control text-center" name="groupbuystate">

                                        <option value="0" <?php if($groupbuystate == 0): ?>selected<?php endif; ?> >全部</option>
                                        <option value="1" <?php if($groupbuystate == 1): ?>selected<?php endif; ?> >进行中</option>
                                        <option value="2" <?php if($groupbuystate == 2): ?>selected<?php endif; ?> >已成团</option>
                                        <option value="3" <?php if($groupbuystate == 3): ?>selected<?php endif; ?> >已失败</option>
                                    </select>
                                </div>
                                 <div class="form-group col-md-1" >
                                    <label for="tmp_id" class="form-inline-label">模板ID：</label>
                                    <input type="text" id="tmp_id" name="tmp_id" class="form-control w150 form-inline-input-group" value="<?php echo ($post["tmp_id"]); ?>" />
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                    ...
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <button class="md-trigger btn btn-primary mrg-b-lg" data-modal="export_order_dialog"
                                                    id="export_order_btn">新建团购</button>
                                        </div>
                                    </header>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): $key = $key+1; ?>
                                                    <tr>
    <td ><input type="checkbox" /> <a href="http://m.shuxiaobai.com/groupbuy/joinGroupBuy/<?php echo ($item["id"]); ?>" target="__blank"><?php echo ($item["id"]); ?></a></td>
    <td><?php echo ($item["username"]); ?></td>
    <td ><img src="<?php echo ($img_site); echo ($item["thum_photo"]); ?>" alt="" width="60"> <br/>
        <?php echo ($item["product_name"]); ?></td>
    <td ><?php echo ($item["groupbuying_name"]); ?></td>
    <td ><?php echo ($item["groupbuying_price"]); ?></td>
    <td><?php echo ($item["groupbuying_begintime"]); ?></td>
    <td><?php echo ($item["groupbuying_endtime"]); ?></td>
    <td><?php echo ($item["groupbuying_reqnums"]); ?></td>
    <td><?php echo ($item["groupbuying_nownums"]); ?></td>
    <td ><?php echo ($item["separatebuy_price"]); ?></td>
    <td ><?php echo ($item["condition_type"]); ?></td>
    <td ><?php echo ($item["condition_num"]); ?></td>
    <td ><?php echo ($item["state"]); ?></td>
    <td >
        <?php if(is_array($item["partake_list"])): foreach($item["partake_list"] as $partake_key=>$partake_item): echo ($partake_item["username"]); ?> 、<?php endforeach; endif; ?>
    </td>
