                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>抢购管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="<?php echo U('PanicBuying/add');?>" class=" btn btn-primary">新建抢购</a>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): $key = $key+1; ?>
                                                    <tr>
    <td><input type="checkbox" name="selected_id[]"/><?php echo ($item["id"]); ?></td>
    <td><?php echo ($item["product_name"]); ?></td>
    <td><?php echo ($item["now_price"]); ?></td>
    <td><?php echo ($item["product_stock"]); ?></td>
    <td></td>
    <td><?php echo ($item["auction_begintime"]); ?></td>
    <td><?php echo ($item["auction_endtime"]); ?></td>
    <td><?php echo ($item["pricechange_type"]); ?></td>
    <td>操作</td>
