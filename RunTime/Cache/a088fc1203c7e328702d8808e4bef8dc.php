                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>发货仓管理</span></li>
                                </ol>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover" style="text-align:center;">
                                                ...
                                                <tr >
                                                    ...
                                                    <th style="text-align:center;">发货仓名</th>
                                                    <th style="text-align:center;">货仓字母名</th>
                                                    <th style="text-align:center;">发货渠道id</th>
                                                    <th style="text-align:center;">发货渠道</th>
                                                    <th style="text-align:center;">始发城市</th>
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): $key = $key+1; ?>
                                                    <tr>
    <td style="text-align:left;text-indent:3px;"><input type="checkbox" />&nbsp;<?php echo ($item["id"]); ?></td>
    <td ><?php echo ($item["name"]); ?></td>
    <td ><?php echo ($item["en_name"]); ?></td>
    <td ><?php echo ($item["supply_id"]); ?></td>
    <td ><?php echo ($item["supply_name"]); ?></td>
    <td ><?php echo ($item["source_city"]); ?></td>
    <td>
        <a href="/index.php?m=Sendwarehome&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Sendwarehome&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
