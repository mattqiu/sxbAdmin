        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Admin&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户名:<span style="color:#fff">做</span></span>
                                    <input id="username" type="text" placeholder="请输入用户名" name="admin_name" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="nickname" id="username" placeholder="请输入昵称" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户密码:</span>
                                    <input style="width:250px;" type="password" name="password" id="username" placeholder="请输入用户密码" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label stt">状<span style="color:#fff">做做</span>态:</span>
