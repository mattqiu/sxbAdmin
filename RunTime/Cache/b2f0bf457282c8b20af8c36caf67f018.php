...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>商品分类列表</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/ProductClass/add" class="md-trigger btn btn-primary mrg-b-lg">添加商品分类</a>
                                        </div>
                                    </header>
    ...
    <td ><?php if($item["is_show"] == 0): ?>否  <?php else: ?>是<?php endif; ?></td>
    <td ><?php if($item["is_split"] == 0): ?>否  <?php else: ?>是<?php endif; ?></td>
    <td ><?php if($item["is_hot"] == 0): ?>否  <?php else: ?>是<?php endif; ?></td>
    <td >
        <a href="/ProductClass/edit/id/<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/ProductClass/del/id/<?php echo ($item["id"]); ?>">删除</a></td>
...
<div class="md-modal md-effect-1 rushToPurchase" id="export_order_dialog">
    <div class="md-content">
        ...
        <form action="/index.php?m=GroupBuyingTml&a=add"  method="post" role="form" id="add_form">
