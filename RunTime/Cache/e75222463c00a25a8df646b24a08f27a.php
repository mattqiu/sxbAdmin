        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Order&a=saveEditOrderInfo"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-8">
                                    <span class="label">订单id（<?php echo ($orderinfo["id"]); ?>）</span>
                                    <span>订单号:     <?php echo ($orderinfo["order_name"]); ?></span>
                                    <span>团单号：<?php echo ($orderinfo["groupbuy_order_name"]); ?></span>
                                </div>
                            </div>

                            <?php if(is_array($orderinfo["order_product"])): foreach($orderinfo["order_product"] as $productKey=>$product): ?><div class="row">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <td rowspan="<?php echo ($orderinfo["order_product_num"]); ?>"><?php echo ($orderinfo["username"]); ?></td>
                                        <td rowspan="<?php echo ($orderinfo["order_product_num"]); ?>"><?php echo ($orderinfo["time"]); ?> <br/> 最后更新: <span class="green"><?php echo ($orderinfo["last_modify_time"]); ?></span></td>
                                        <td rowspan="<?php echo ($orderinfo["order_product_num"]); ?>"><?php echo ($orderinfo["order_status_name"]); ?></td>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    <span class="label">现在的收件人信息:</span>
                                    <tr>
                                        <td colspan="12">收件人： <?php echo ($orderinfo["name"]); ?>  <?php echo ($orderinfo["mobile"]); ?>  送货时间：<?php echo ($orderinfo["shtime"]); ?><br/>收货地址：<?php echo ($orderinfo["address"]); ?></td>
                                    </tr>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-3">
                                    <span class="label">新收件人:</span>
                                    <input type="text" name="new_recv_name" id="new_recv_name" value="" class="form-control col-xs-5"/>
                                </div>
                                <div class="form-group col-xs-3">
                                    <span class="label">手机号码:</span>
                                    <input type="text" name="new_recv_phone" id="new_recv_phone" value="" class="form-control col-xs-5"/>
                                </div>
                                <div class="form-group col-xs-6">
                                    <span class="label">收货地址:</span>
                                    <input type="text" name="new_recv_addr" id="new_recv_addr" value="" class="form-control col-xs-8"/>
                                </div>
                            </div>


                            <input type="hidden" value="<?php echo ($orderinfo["id"]); ?>" name="id" />
                            <input type="hidden" value="<?php echo ($orderinfo["groupbuy_order_name"]); ?>" name="groupbuyorder_name" />
