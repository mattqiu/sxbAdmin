...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>O2O模板管理</span></li>
                                </ol>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-center">O2O模板id</th>
                                                    <th class="text-center">成团所需金额</th>
                                                    <th class="text-center">成团所需人数</th>
                                                    <th class="text-center">成团条件</th>
                                                    <th class="text-center">配送时间</th>
                                                    <th class="text-center">成团时间</th>
    ...
    <td><?php echo ($item["o2o_money"]); ?>元</td>
    <td><?php echo ($item["o2o_nums"]); ?>人</td>
    <td>
        <?php if($item["condition"] == 1): ?>金额 or 人数
        <?php else: ?>金额 and 人数<?php endif; ?>

    </td>
    <td><?php echo ($item["delivery_time"]); ?></td>
    <td><?php echo ($item["group_ok_time"]); ?></td>
    <td>
        <a href="/index.php?m=Ogrouptml&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Ogrouptml&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
