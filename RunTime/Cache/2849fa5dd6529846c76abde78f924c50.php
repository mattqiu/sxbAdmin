                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    ...
                                                    <select  id="site" class="form-control w150 text-center form-inline-input-group" name="site">
                                                            <option value=" " <?php if($post["site"] == ' '): ?>selected<?php endif; ?>>------所有------</option>
                                                            <option value="1" <?php if($post["site"] == 1): ?>selected<?php endif; ?>>------嘉善------</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="data_name" colspan="2"><?php echo ($count_user['cid']); ?>人</th>
                                                </tr>
                                                <tr>
                                                    <th class="text-right data_name">绑定手机用户数:</th>
                                                    <th colspan="4">
                                                        <div class="back whalf">
                                                            <div class="front green-bg" style="width:<?php echo ($user_mobile); ?>;font-size:11px;"><?php echo ($cmb); ?>人&nbsp;&nbsp;<?php echo ($user_mobile); ?></div>
                                                        </div>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th colspan="4">
                                                        <div class="back whalf">
                                                            <div class="front red-bg" style="width:<?php echo ($user_orders); ?>;font-size:11px;"><?php echo ($code); ?>人&nbsp;&nbsp;<?php echo ($user_orders); ?></div>
                                                        </div>
                                                    </th>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th colspan="5" class="text-center" style="cursor:pointer;">
                                                ...
                                                <tbody id="list_order_tby">
                                                        ...
                                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="order_money">
                                                                <td><?php echo ($vo["id"]); ?></td>
                                                                <td><?php echo ($vo["username"]); ?></td>
                                                                <td><?php echo ($vo["mobile"]); ?></td>
                                                                <td><?php echo ($vo["sm"]); ?>元</td>
                                                        ...
                                                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr class="order_nums num_hidden">
                                                                <td><?php echo ($vol["id"]); ?></td>
                                                                <td><?php echo ($vol["username"]); ?></td>
                                                                <td><?php echo ($vol["mobile"]); ?></td>
                                                                <td><?php echo ($vol["con"]); ?>单</td>
                                                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
