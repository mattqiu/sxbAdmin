                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/coupon" method="post" target="_self" role="form" id="order_search_form">


                                            <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    <label for="sms_send_showtext" class="form-inline-label">选择券类型：</label>
                                                    <select  id="sms_send_showtext" class="form-control w150 text-center form-inline-input-group" name="sms_send_showtext">
                                                        <option value="11" <?php if($post["sms_send_showtext"] == 11): ?>selected<?php endif; ?>>------全部------</option>
                                                        <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo[0]); ?>" <?php if($post["sms_send_showtext"] == $vo[0]): ?>selected<?php endif; ?> >---<?php echo ($vo[0]); ?>---</option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    ...
                                    <div class="main-box-body clearfix" style="margin-top:30px;">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                <thead>
                                                <tr >
                                                    <th colspan="4" class="text-idt">已发放优惠券总量：&nbsp;<span class="green"><?php echo ($coupon_All['cid']); ?></span>&nbsp;张</th>
                                                </tr>
                                             <tr >
                                                    <th colspan="4" class="text-idt">已使用优惠券总量：&nbsp;<span class="red"><?php echo ($coupon_Used['cid']); ?></span>&nbsp;张</th>
                                                </tr>
                                                <tr>
                                                    <th class="text-center">日期</th>
                                                    <th class="text-center">发放总量</th>
                                                ...
                                                <tbody id="list_order_tby">
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo ($val["total"]); ?>&nbsp;张</td>
                                                            <td> <?php if($val["used_total"] != ''): echo ($val["used_total"]); ?>&nbsp;张<?php else: ?>未使用<?php endif; ?></td>
                                                            <td><?php echo ($val["ratio"]); ?></td>
