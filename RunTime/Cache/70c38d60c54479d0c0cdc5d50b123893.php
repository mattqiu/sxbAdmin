                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>优惠券管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/<?php echo (MODULE_NAME); ?>/create" class="btn btn-primary mrg-b-lg">生成优惠券</a>
                                        </div>

                                        <form action="/<?php echo (MODULE_NAME); ?>&a=index" method="post" target="_self" role="form">
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    <label for="begin_time" class="form-inline-label">开始时间：</label>
                                                    <input type="text" name="time" class="form-control w150 form-inline-input-group" value="<?php echo ($time); ?>" id="begin_time" />

                                                </div>

                                                <div class="form-group col-md-3">
                                                    <label for="to_date" class="form-inline-label">有效期至：</label>
                                                    <input type="text" name="to_date" class="form-control w150 form-inline-input-group" value="<?php echo ($to_date); ?>" id="to_date" />
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <label for="user_name" class="form-inline-label">关联用户：</label>
                                                    <input type="text" name="user_name" class="form-control w150 form-inline-input-group" value="<?php echo ($user_name); ?>" id="user_name" />
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    <label for="card_number" class="form-inline-label">券号：</label>
                                                    <input type="text" name="card_number" class="form-control w150 form-inline-input-group" value="<?php echo ($card_number); ?>" id="card_number" />
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <label for="is_used" class="form-inline-label">是否使用：</label>
                                                    <select  id="is_used" class="form-control w100 form-inline-input-group" name="is_used">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="is_sent" class="form-inline-label">是否发放：</label>
                                                    <select  id="is_sent" class="form-control w100 form-inline-input-group" name="is_sent">
                                                        <option value="0">请选择</option>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): $key = $key+1; ?>
                                                    <tr>
    <td ><input type="checkbox" /><?php echo ($item["id"]); ?></td>
    <td ><img src="<?php echo ($img_site); echo ($item["thum_photo"]); ?>" alt="" width="60"> <br/>
        <?php echo ($item["card_number"]); ?></td>
    <td ><?php echo ($item["card_money"]); ?></td>
    <td ><?php echo ($item["is_used"]); ?></td>
    <td ><?php echo ($item["time"]); ?></td>
    <td ><?php echo ($item["to_date"]); ?></td>
    <td ><?php echo ($item["is_sent"]); ?></td>
    <td ><?php echo ($item["coupon_type"]); ?></td>
    <td ><?php echo ($item["groupbuy_limit_value"]); ?></td>
    <td ><?php echo ($item["direction"]); ?></td>
    <td ><?php echo ($item["use_target"]); ?></td>
