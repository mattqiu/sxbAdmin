        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Omerchant&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户名称：</span>
                                    <input id="username" type="text" placeholder="请输入商户名" name="o2o_name" value="<?php echo ($result["o2o_name"]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户属省：</span>
                                    <input id="" type="text" placeholder="" name="" disabled value="<?php echo ($address[0][name]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户属市：</span>
                                    <input id="" type="text" placeholder="" name="" disabled value="<?php echo ($address[1][name]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户属区：</span>
                                    <input id="" type="text" placeholder="" name="" disabled value="<?php echo ($address[2][name]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户属镇：</span>
                                    <input id="" type="text" placeholder="" name="" disabled value="<?php echo ($address[3][name]); ?>" class="form-control col-xs-6"/>
                                </div>

                            </div>
                            <!--<div class="row">-->
                                <!--<div class="form-group col-xs-5" >-->
                                    <!--<label class="label">修改地址：</label>-->
                                        <!--<select  id="prov" class="form-control w100 text-center form-inline-input-group" name="province">-->
                                        <!--<option value="">请选择省</option>-->
                                        <!--</select>-->
                                    <!--<select  id="city" class="form-control w100 text-center form-inline-input-group" name="city"></select>-->
                                    <!--<select  id="area" class="form-control w100 text-center form-inline-input-group" name="area"></select>-->
                                    <!--<select  id="town" class="form-control w100 text-center form-inline-input-group" name="town"></select>-->
                                <!--</div>-->
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="address" id="address" placeholder="请输入详细地址" value="<?php echo ($result["address"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">商户电话：</span>
                                    <input type="text" name="phone" id="phone" placeholder="请输入商户电话" value="<?php echo ($result["phone"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <input type="hidden" name="id" value="<?php echo ($result["id"]); ?>">
                            <div class="modal-footer">
                                <button id="form_save" class="btn btn-primary" style="float:left;">修改</button>
                            </div>
                        </div>
                    </form>
                </div>
...
$(function($){
    ...
    $.ajax({
        url : "<?php echo U('Omerchant/areaList');?>",
        data : {pid:0},
        type : 'post',
        async : false,
        success : function(data){
            for(var i = 0;i < data.length; i++){
                var strHttpp = "<option value='" +
                                    data[i].id + "'"+
                                    "" +
                                "<?php if("+                                list.province +                                 " == " +                                 data[i].id + " ): ?>selected<?php endif; ?>" +
                                    ">" +
                                    data[i].name+
                                "</option>"
                        ;
                $('#prov').append(strHttpp);
            }
        },
        error:function(){
            alert('出错了!');
    ...
    $('#prov,#city,#area,#town').change(function(){
        var pid = $(this).val();
        var _this = $(this);
        $.ajax({
            url : "<?php echo U('Omerchant/areaList');?>",
            ...
            success : function(data){
                ...
                _this.nextAll('select').empty().show();
