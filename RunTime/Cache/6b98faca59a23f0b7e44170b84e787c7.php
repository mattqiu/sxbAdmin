...
<div id="nav-col">
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/User/adduser" class="btn btn-primary mrg-b-lg">新增用户</a>
                                        </div>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-center"><input type="checkbox" id="check_all"/>&nbsp;选择（id）</th>
    ...
    <td > <img src="<?php echo ($img_site); echo ($item["user_head"]); ?>" alt=""> </td>
    <td > <?php if($item["sex"] == 0): ?>未填写<?php elseif($item["sex"] == 1): ?>男<?php else: ?>女<?php endif; ?> </td>
    <td ><?php echo ($item["reg_time"]); ?></td>
    <td>
        <a href="/index.php?m=User&a=edituser&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=User&a=deluser&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
