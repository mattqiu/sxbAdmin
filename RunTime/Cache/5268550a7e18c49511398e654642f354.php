        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/<?php echo (MODULE_NAME); ?>/save"  method="post" role="form" id="add_form" >
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <select name="position" id="position" class="form-control col-xs-2" >
                                        ...
                                        <?php if(is_array($position_conf)): foreach($position_conf as $key=>$item): ?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <select name="type" id="type" class="form-control col-xs-2" autocomplete="off">
                                        <option value="" selected="selected">请选择</option>
                                        <?php if(is_array($type_conf)): foreach($type_conf as $key=>$item): ?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
