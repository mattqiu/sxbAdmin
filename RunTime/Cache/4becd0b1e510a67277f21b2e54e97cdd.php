...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>优惠券模板管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/<?php echo (MODULE_NAME); ?>/create" class="btn btn-primary mrg-b-lg">添加掉落组</a>
                                        </div>
                                    </header>
    ...
    <td ><?php echo ($item["drop_rate"]); ?></td>
    <td >
        <?php if(is_array($item["mutex_data"])): foreach($item["mutex_data"] as $key=>$mutex_item): if(is_array($mutex_item)): foreach($mutex_item as $key=>$item_item): ?><div><?php echo ($item_item); ?></div><?php endforeach; endif; endforeach; endif; ?>
    </td>
    <td><a href="/<?php echo (MODULE_NAME); ?>/del/id/<?php echo ($item["id"]); ?>" class="btn btn-primary mrg-b-lg">删除</a>
        <a href="/<?php echo (MODULE_NAME); ?>/edit/id/<?php echo ($item["id"]); ?>" class="btn btn-primary mrg-b-lg">编辑</a>
        <a href="/<?php echo (MODULE_NAME); ?>/clear_userlimit/id/<?php echo ($item["id"]); ?>" class="btn btn-primary mrg-b-lg">清除用户掉落限制</a>
    </td>
