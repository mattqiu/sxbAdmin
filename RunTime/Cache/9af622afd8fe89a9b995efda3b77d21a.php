...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>团购模板管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/GroupBuyingTml/add" class="btn btn-primary mrg-b-lg">新建团购模板</a>
                                        </div>
                                    </header>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$item): $key = $key+1; ?>
                                                    <tr>
    <td ><input type="checkbox" /><a href="/index.php?m=GroupBuying&a=getgroupbuy_condition&tmp_id=<?php echo ($item["id"]); ?>" target="_blank"><?php echo ($item["id"]); ?></a></td>
    ...
    <td ><?php echo ($item["canbuy_times"]); ?></td>
    <td>
        <div style="min-width: 80px">
        <a href="<?php echo ($frontSiteUrl); ?>detail/groupbuy/<?php echo ($item["id"]); ?>" target="_blank">预览</a>
        <a href="/index.php?m=GroupBuyingTml&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=GroupBuyingTml&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
        </div>

        <div style="min-width: 80px">
        <a href="/index.php?m=GroupBuyingTml&a=clear_userlimit&id=<?php echo ($item["id"]); ?>">清除参团限制</a>
        </div>
        <div style="min-width: 80px">
        <a href="/index.php?m=GroupBuyingTml&a=clear_succ_userlimit&id=<?php echo ($item["id"]); ?>">清除成团限制</a>
        </div>
    </td>
