        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=User&a=saveadduser"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户id（机器人定义1-10000）:</span>
                                    <input id="id" type="text" value="1" name="id" class="form-control col-xs-6"/>
                                </div>

                                <div class="form-group col-xs-5">
                                    <span class="label">用户名:</span><input id="username" type="text" value="000" name="username" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">密码(默认:b2f46e871bf65ffd58fd8cf078989a2f):</span>
                                    <input type="text" name="password" id="password" value="b2f46e871bf65ffd58fd8cf078989a2f" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">手机:</span>
                                    <input type="text" name="mobile" id="mobile" value="111" class="form-control col-xs-3"/>
                                </div>
                                <div class="form-group col-xs-5">
                                    <span class="label">性别:</span>
                                    <input type="text" name="sex" id="sex" value="0" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">头像id:</span>
                                    <input type="text" name="user_head" id="user_head" value="" class="form-control col-xs-5" onblur="headpiconblur"/>
                                </div>
                            </div>
