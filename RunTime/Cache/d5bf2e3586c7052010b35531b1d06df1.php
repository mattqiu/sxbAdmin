                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/volume" method="post" target="_self" role="form" id="order_search_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    ...
                                                    <select  id="send" class="form-control w150 text-center form-inline-input-group" name="send">
                                                        <option value="1" <?php if($post["send"] == 1): ?>selected<?php endif; ?>>------所有------</option>
                                                        <?php if(is_array($send)): $i = 0; $__LIST__ = $send;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($post["send"] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-3" >
                                                    <label for="datepickerDateFrom" class="form-inline-label labels">时间区间：</label>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center"><?php echo (substr($week[0],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[1],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[2],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[3],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[4],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[5],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[6],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[7],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[8],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[9],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[10],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[11],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[12],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[13],5,5)); ?></th>
                                                    <th class="text-center"><?php echo (substr($week[14],5,5)); ?></th>
                                                ...
                                                <tbody class="tbo">
                                                    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td class="text-left"><?php echo ($vol["product_name"]); ?></td>
                                                            <td><?php echo ($vol["total"]); ?></td>
                                                            <td><?php echo ($vol["one"]); ?></td>
                                                            <td><?php echo ($vol["seven"]); ?></td>
                                                            <td><?php echo ($vol["two"]); ?></td>
                                                            <td><?php echo ($vol["three"]); ?></td>
                                                            <td><?php echo ($vol["four"]); ?></td>
                                                            <td><?php echo ($vol["five"]); ?></td>
                                                            <td><?php echo ($vol["six"]); ?></td>
                                                            <td><?php echo ($vol["eight"]); ?></td>
                                                            <td><?php echo ($vol["nine"]); ?></td>
                                                            <td><?php echo ($vol["ten"]); ?></td>
                                                            <td><?php echo ($vol["eleven"]); ?></td>
                                                            <td><?php echo ($vol["twelve"]); ?></td>
                                                            <td><?php echo ($vol["thirteen"]); ?></td>
                                                            <td><?php echo ($vol["fourteen"]); ?></td>
                                                            <td><?php echo ($vol["fifteen"]); ?></td>
                                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    <tr>
                                                        <td colspan="2">商品总销量</td>
                                                        <td><?php echo ($dayVolume['total']); ?></td>
                                                        <td><?php echo ($dayVolume['one']); ?></td>
                                                        <td><?php echo ($dayVolume['seven']); ?></td>
                                                        <td><?php echo ($dayVolume['two']); ?></td>
                                                        <td><?php echo ($dayVolume['three']); ?></td>
                                                        <td><?php echo ($dayVolume['four']); ?></td>
                                                        <td><?php echo ($dayVolume['five']); ?></td>
                                                        <td><?php echo ($dayVolume['six']); ?></td>
                                                        <td><?php echo ($dayVolume['eight']); ?></td>
                                                        <td><?php echo ($dayVolume['nine']); ?></td>
                                                        <td><?php echo ($dayVolume['ten']); ?></td>
                                                        <td><?php echo ($dayVolume['eleven']); ?></td>
                                                        <td><?php echo ($dayVolume['twelve']); ?></td>
                                                        <td><?php echo ($dayVolume['thirteen']); ?></td>
                                                        <td><?php echo ($dayVolume['fourteen']); ?></td>
                                                        <td><?php echo ($dayVolume['fifteen']); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
