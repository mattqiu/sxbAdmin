            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">评论商品</h4>
                    </div>
                    <form action="/index.php?m=Comment&a=savecommentproduct"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">

                                <div class="form-group col-xs-5">
                                    <span class="label">商品（product）id:</span>
                                    <input id="product_id" type="text" value="0" name="product_id" class="form-control col-xs-3"/>
                                </div>

                                <div class="form-group col-xs-5">
                                    <span class="label">生成方式（0单一插入，1随机）:</span><input id="comment_flag" type="text" value="0" name="comment_flag" class="form-control col-xs-6"/>
                                </div>
                                <div class="form-group col-xs-5">
                                    <span class="label">单一插入的评论模板id:</span>
                                    <input type="text" name="comment_tml_id" id="comment_tml_id" value="0" class="form-control col-xs-3"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">生成评论数量（最大100）:</span>
                                    <input type="text" name="comment_num" id="comment_num" value="1" class="form-control col-xs-3"/>
                                </div>
                            </div>
