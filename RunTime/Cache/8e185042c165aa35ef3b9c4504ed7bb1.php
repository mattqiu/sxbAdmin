            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">O2O商品编辑</h4>
                    </div>
                    <form action="/index.php?m=Ostock&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商品名称：</span>
                                    <input id="product_name" type="text" disabled value="<?php echo ($name); ?>" name="product_name" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="stock" id="stock" placeholder="请输入商品库存 例：5" value="<?php echo ($result["stock"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">商品价格：</span>
                                    <input type="text" name="o2o_goods_price" value="<?php echo ($result["o2o_goods_price"]); ?>" id="o2o_goods_price" placeholder="请输入商品库存 例：15.3" class="form-control col-xs-5"/>
                                </div>
                            </div>
