                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <div class="main-box-header-act">
                            <div>
                                <span>根据实例id导入(csv)</span>
                                <button class="md-trigger btn btn-primary mrg-b-lg" data-modal="import_send_order_dialog"
                                    id="import_send_order_btn">导入中奖名单
                                </button>
                            </div>

                            <div>
                                <div>
                                <span>根据模板id和中奖码,及时间，先成团的数量等直接开奖(csv)</span>
                                </div>
                                <button class="md-trigger btn btn-primary mrg-b-lg" data-modal="import_send_tmlid_dialog"
                                        id="import_send_tmlid_btn">导入开奖模板和编号
                                </button>
                            </div>

                        </div>
                    </div>
                    <form action="/index.php?m=GroupBuying&a=savechoujiang"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-6">
                                    <span class="label">集中抽奖中奖号码（没开奖不要输入任何内容）:</span>
                                    <input type="text" name="focus_luckdraw_winning_no" id="focus_luckdraw_winning_no" value="" class="form-control col-xs-3"/>
                                </div>
                            </div>

                            <div class="row">
                                <div class="form-group col-xs-10">
                                    <span class="label">输入中奖的团实例id（英文“,”分隔）:</span>
                                    <input type="text" name="focus_luckdraw_winning_groupbuyinsts" id="focus_luckdraw_winning_groupbuyinsts" value="" class="form-control col-xs-8"/>
                                </div>
                            </div>
...
<div class="md-modal md-effect-1" id="import_send_order_dialog">
    <div class="md-content">
        ...
        <form action="/<?php echo (MODULE_NAME); ?>/importLuck" enctype="multipart/form-data" method="post" role="form">
            <div class="modal-body">
                <div class="row">
...
<div class="md-modal md-effect-1" id="import_send_tmlid_dialog">
    <div class="md-content">
        ...
        <form action="/<?php echo (MODULE_NAME); ?>/importLuck_by_tml_no" enctype="multipart/form-data" method="post" role="form">
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        <label  class="form-inline-label">选择文件：</label>
