                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-3">
                                    <span class="label">团购价格:</span><input type="text" name="groupbuying_price" id="groupbuying_price" class="form-control col-xs-3"/>
                                </div>

                                <div class="form-group col-xs-3">
                                    <span class="label">身边拼价格:</span><input type="text" name="sidesplicing_price" id="sidesplicing_price" class="form-control col-xs-3"/>
                                </div>

                                <div class="form-group col-xs-3">
                                    <span class="label">成团人数:</span><input type="text" name="groupbuying_reqnums" id="groupbuying_reqnums" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <input type="text" name="b_drop_group_id" id="b_drop_group_id" class="form-control col-xs-3 modals_radio_select_input"
                                           value=""/>
                                </div>
                                ...
                                <div class="form-group col-xs-5">
                                    ...
                                    <select name="is_begin_give_leader" id="is_begin_give_leader">
                                        <option value="0" selected="selected" >不给团长</option>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-5">
                                    ...
                                    <select name="only_coupon_pay" id="only_coupon_pay">
                                        <option value="0" selected="selected">正常支付</option>
                                        <option value="1" >只能使用优惠券支付</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row" id="use_coupon_2_coupon" add_line="0">
                                <div class="row coupon2coupon_line">
                                    <div class="form-group col-xs-10">
                                        <span class="">优惠券模板id</span>
                                        <a href="javascript:void(0);"class="modals_radio_select md-trigger btn btn-primary"
                                        data-inputId="use_coupon_tml_id_0" data-url="/Droplist/selectJson"
                                        data-title="选择优惠券模板" data-modal="modal_radio_select">选择优惠券模板</a>
                                        <input type="text" name="use_coupon_tml_id[]" class="form-control col-xs-1 modals_radio_select_input" id="use_coupon_tml_id_0"/>

                                        <span class="label">券买券掉落组:</span>
                                        <a href="javascript:void(0);" class="modals_radio_select md-trigger btn btn-primary"
                                        data-inputId="c2c_drop_group_id_0" data-url="/Droplist/selectDroplistGroupJson"
                                        data-title="选择掉落组" data-modal="modal_radio_select">选择掉落组</a>
                                        <input type="text" name="c2c_drop_group_id[]" id="c2c_drop_group_id_0" class="form-control col-xs-1 modals_radio_select_input"
                                           value=""/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <select name="ismemberprice_diff" id="ismemberprice_diff">
                                        ...
                                        <option value="1" selected="selected" >一致</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-5">
                                    ...
                                    <select name="groupbuy_type" id="groupbuy_type">
                                        <option value="0" selected="selected">普通拼团</option>
                                        <option value="1">助力团</option>
                                        <option value="2">集中抽奖团</option>
                                        <option value="3">掉落抽奖团</option>
                                        <option value="4">拼星星团</option>
                                    </select>
                                </div>
