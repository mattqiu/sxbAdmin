...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>O2O商家管理</span></li>
                                </ol>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-center">O2O商户id</th>
                                                    <th class="text-center">商户名</th>
                                                    <th class="text-center">商户省ID</th>
                                                    <th class="text-center">商户市ID</th>
                                                    <th class="text-center">商户区ID</th>
                                                    <th class="text-center">商户镇ID</th>
                                                    <th class="text-left">商户详细地址</th>
                                                    <th class="text-center">商户电话</th>
                                                    <th class="text-center">开商户首团</th>
    ...
    <td class="merchant_id"><?php echo ($item["id"]); ?></td>
    <td><?php echo ($item["o2o_name"]); ?></td>
    ...
    <td>
        <a href="javaScript:;" class="o2oCreate">开团</a>
    </td>
    <td>
        <a href="/index.php?m=Omerchant&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Omerchant&a=del&id=<?php echo ($item["id"]); ?>" id="del">删除</a>
    </td>
...
<script type="text/javascript">
$(function($){
    $('.o2oCreate').on('click',function(){
        var id = $(this).parent().parent().children('.merchant_id').html();
        if(confirm('您确定要为此商户开第一团吗？')){
            $.ajax({
                type : 'post',
                url : "<?php echo U('Omerchant/create');?>",
                data : 'id='+id,
                dataType : 'json',
