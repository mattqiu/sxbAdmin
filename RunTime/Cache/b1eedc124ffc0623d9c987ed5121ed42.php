...
<style>
    ...
    #add_form input[type="text"]{width:250px;}
    #add_form .stt{margin-top: -5px;}
    .btn_search{height:32px;width:50px;color:#fff;text-align:center;line-height:30px;cursor:pointer;border:1px solid #3498db;border-radius:3px;background-color:#3498db;}
</style>
<body>
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">添加用户至黑名单</h4>
                    </div>
                    <form action="/index.php?m=BlackList&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">

                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">用户ID：</span>
                                    <input type="text" name="uid" id="userid" placeholder="请输入用户ID" class="form-control col-xs-5"/>
                                </div>                                
                            </div>
                    ...
                    <div class="form-group col-xs-5" style="width:500px;float:right;margin-right:20px;position:relative;top:-135px;">
                        <span class="label">手机号搜索用户ID：</span>
                        <input type="text" name="mobile" id="mobile" placeholder="请输入手机号" style="width:110px;" class="form-control col-xs-5"/>
                        <span style="font-weight:bold;font-size:12px;margin-left:10px;">用户ID：</span>
                        <input type="text" name="uids" id="user_id" value="" style="width:100px;" class="form-control col-xs-5"/>
                        <button id="search" class="btn_search">搜索</button>
                    </div>
                </div>
            </div>
...
$(function($){
    ...
    $("#search").click(function(){
        ...
        var uid = $("#userid").val();
        var data = {'data':mobile};
        var url='<?php echo U("BlackList/search");?>';
