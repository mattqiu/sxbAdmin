...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>邮费管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/Postage/add/parent_id/<?php echo ($pid); ?>" class="btn btn-primary mrg-b-lg">新增地址</a>
                                        </div>
                                    </header>
    ...
    <td ><a href="/postage/county/id/<?php echo ($item["id"]); ?>/areaname/<?php echo ($item["name"]); ?>/provincename/<?php echo ($provincename); ?>/"> <?php echo ($item["name"]); ?></a></td>
    <td ><?php echo ($item["zipcode"]); ?></td>
    <td ><?php echo ($item["first_weight"]); ?></td>
    <td ><?php echo ($item["first_weight_money"]); ?></td>
    <td ><?php echo ($item["follow_weight_money"]); ?></td>
    <td><?php echo ($item["active"]); ?></td>
    <td>
        <a href="/index.php?m=Postage&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Postage&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
