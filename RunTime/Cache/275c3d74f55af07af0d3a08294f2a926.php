        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Role&a=savenode"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <?php if(is_array($nodes)): foreach($nodes as $key=>$vo): ?><!-- <input id="username" type="checkbox" placeholder="请输入角色名称" name="name" class="form-control col-xs-6"/> -->
                                    <input type="checkbox" name="node[]"  value="<?php echo ($vo["id"]); ?>"  <?php if(in_array($vo['id'],$ro_nodes) == true): ?>checked<?php endif; ?>>&nbsp;<?php echo ($vo["name"]); ?>&nbsp;&nbsp;
                                    <?php if($vo["id"] %5 == 0 ): ?><br><?php endif; ?><br /><?php endforeach; endif; ?>
                                </div>
