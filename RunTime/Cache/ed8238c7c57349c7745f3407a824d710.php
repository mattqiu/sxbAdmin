...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>首页广告位管理</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/<?php echo (MODULE_NAME); ?>/create" class="btn btn-primary mrg-b-lg">添加</a>
                                        </div>
                                    </header>
    ...
    <td ><img src="<?php echo ($img_site); echo ($item["photo"]); ?>" alt="" width="80"></td>
    <td ><?php echo ($item["position"]); ?></td>
    <td ><?php echo ($item["title"]); ?></td>
    <td ><a href="javascript:void(0);" class="is_show" data-id="<?php echo ($item["id"]); ?>" data-key="is_show" ><?php echo ($item["is_show"]); ?></a> </td>
    <td><a href="javascript:void(0);" class="edit_cell_txt" data-id="<?php echo ($item["id"]); ?>" data-key="sort"><?php echo ($item["sort"]); ?></a></td>
    <td ><?php echo ($item["panicbuying_id"]); ?></td>
    <td ><?php echo ($item["groupbuyingtml_id"]); ?></td>
    <td>
        <a href="/<?php echo (MODULE_NAME); ?>/edit/id/<?php echo ($item["id"]); ?>">编辑</a> <br/>
        <a href="/<?php echo (MODULE_NAME); ?>/del/id/<?php echo ($item["id"]); ?>">删除</a>
    </td>
...
$(function($){
    ...
    $('.is_show').on('click', function(){
        ...
        var bannerId = _this.attr('data-id');
        MessageBox.confirm('要切换此广告位的显示吗', function(){
            var url = '/<?php echo (MODULE_NAME); ?>/upInfo';
            var data = {id : bannerId, key: key};
    ...
    $('.edit_cell_txt').on('click', function(){
        var _this = $(this);
        var key = _this.attr('data-key');
        var id = _this.attr('data-id');
        var beValue = _this.text();
        _this.html('<input type="text" value="' + beValue + '" />');
