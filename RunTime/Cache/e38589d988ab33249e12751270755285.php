            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">商户实例添加</h4>
                    </div>
                    <form action="/index.php?m=Omerchantmsg&a=doadd"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">商户经度：</span>
                                    <input  type="text" name="longitade" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="lat" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <select  class="form-control col-xs-2 text-center form-inline-input-group" name="o2o_id">
                                        ...
                                        <?php if(is_array($merchant)): foreach($merchant as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["o2o_name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="distribution_time_id"  class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
