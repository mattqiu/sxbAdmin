                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><!-- <input id="username" type="checkbox" placeholder="请输入角色名称" name="name" class="form-control col-xs-6"/> -->
                                    <input type="radio" name="role[]"  value="<?php echo ($vo["id"]); ?>"  <?php if(in_array($vo['id'],$role) == true): ?>checked<?php endif; ?>>&nbsp;<?php echo ($vo["name"]); ?>&nbsp;&nbsp;
                                    <!-- <?php if($vo["id"] %5 == 0 ): ?><br><?php endif; ?><br /> --><?php endforeach; endif; ?>
                                </div>

                            </div>
                             <input type="hidden" name="uid" value="<?php echo ($users["admin_id"]); ?>">
