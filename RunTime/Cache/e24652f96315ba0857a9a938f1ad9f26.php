...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>订单评价管理</span></li>
                                </ol>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-left"><input type="checkbox" id="check_all"/>&nbsp;选择</th>
    ...
    <td class="text-left"><input type="checkbox" class="checkComment" />&nbsp;<?php echo ($item["id"]); ?></td>
    ...
    <td >
        <?php if($item.images): ?><img src="<?php echo ($img_site); echo ($item["images"]); ?>" alt="" width="60"><?php else: endif; ?>
    </td>
    <td ><?php echo ($item["star"]); ?></td>
    <td ><?php if($item["is_review"] == 0): ?>未审核<?php else: ?>已通过<?php endif; ?></td>
    <td ><?php if($item["recommend"] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
    <td><?php echo ($item["time"]); ?></td>
    <td >
        <?php if($item["is_review"] == 0): ?><div class="normaldiv">
            <button class="pass_btn md-trigger btn btn-primary mrg-b-lg" data-modal="create_pick_up_goods_dialog"
                    commentid="<?php echo ($item["id"]); ?>">通过</button>
            <button class="refuse_btn md-trigger btn btn-primary mrg-b-lg" data-modal="create_pick_up_goods_dialog"
                    commentid="<?php echo ($item["id"]); ?>">拒绝</button>
            </div>

        <?php elseif($item["is_review"] == 1 and $item["recommend"] == 0): ?>
            <div class="normaldiv">
            <button class="recomment_btn md-trigger btn btn-primary mrg-b-lg" data-modal="create_pick_up_goods_dialog"
                    commentid="<?php echo ($item["id"]); ?>">置顶</button>
            <button class="del_btn md-trigger btn btn-primary mrg-b-lg" data-modal="create_pick_up_goods_dialog"
                    commentid="<?php echo ($item["id"]); ?>">删除</button>
            </div>
        <?php else: ?>
            <div class="normaldiv">
            <button class="del_btn md-trigger btn btn-primary mrg-b-lg" data-modal="create_pick_up_goods_dialog"
...
$(function($){
    ...
    $('#check_all').on('change', function(){
            ...
            if(is_checked){
                $('.checkComment').prop('checked', true);
            } else {
