                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/group" method="post" target="_self" role="form" id="order_search_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3 w370" >
                                                    ...
                                                    <select  id="site" class="form-control w150 text-center form-inline-input-group" name="site">
                                                        <option value="" <?php if($post["site"] == 11): ?>selected<?php endif; ?>>------全部------</option>
                                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["distributor_id"]); ?>" <?php if($post["site"] == $vo['distributor_id']): ?>selected<?php endif; ?> >------<?php echo ($vo["short_name"]); ?>------</option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                ...
                                                <div class="form-group col-md-3 w370" >
                                                    ...
                                                    <select  id="sort" class="form-control w150 text-center form-inline-input-group" name="sort">
                                                        <option value="" <?php if($post["sort"] == ''): ?>selected<?php endif; ?>>------默认------</option>
                                                        <option value="1" <?php if($post["sort"] == 1): ?>selected<?php endif; ?>>成团所需人数&nbsp;↑</option>
                                                        <option value="2" <?php if($post["sort"] == 2): ?>selected<?php endif; ?>>成团所需人数&nbsp;↓</option>
                                                        <option value="3" <?php if($post["sort"] == 3): ?>selected<?php endif; ?>>--开团数量&nbsp;↑--</option>
                                                        <option value="4" <?php if($post["sort"] == 4): ?>selected<?php endif; ?>>--开团数量&nbsp;↓--</option>
                                                        <option value="5" <?php if($post["sort"] == 5): ?>selected<?php endif; ?>>--成团数量&nbsp;↑--</option>
                                                        <option value="6" <?php if($post["sort"] == 6): ?>selected<?php endif; ?>>--成团数量&nbsp;↓--</option>
                                                        <option value="7" <?php if($post["sort"] == 7): ?>selected<?php endif; ?>>--成团人数&nbsp;↑--</option>
                                                        <option value="8" <?php if($post["sort"] == 8): ?>selected<?php endif; ?>>--成团人数&nbsp;↓--</option>
                                                        <option value="9" <?php if($post["sort"] == 9): ?>selected<?php endif; ?>>--成团比率&nbsp;↑--</option>
                                                        <option value="10" <?php if($post["sort"] == 10): ?>selected<?php endif; ?>>--成团比率&nbsp;↓--</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-5 " >
                                                    <label for="group_type" class="form-inline-label">选择团购类型：</label>
                                                    <select  id="group_type" class="form-control text-center form-inline-input-group" name="group_type">
                                                        <option value="" <?php if($post["group_type"] == ''): ?>selected<?php endif; ?>>------全部------</option>
                                                        <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["product_id"]); ?>" <?php if($post["group_type"] == $vo['product_id']): ?>selected<?php endif; ?> ><?php echo ($vo["groupbuying_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            ...
                                            <table id="table-example-fixed" class="table text-center table-hover">
                                                ...
                                                <tr >
                                                    <th colspan="6" class="text-idt">
                                                        助力扫码用户数：&nbsp;<span class="green  "><?php echo ($zhuli_new_user_num); ?></span> 人
                                                    </th>
                                                </tr>
                                                <tr >
                                                    <th colspan="6" class="text-idt">
                                                        已开团数量：&nbsp;<span class="green  "><?php echo ($groupAll['total']); ?></span>&nbsp;团&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        已成团数量：&nbsp;<span class="red font20"><?php echo ($groupOk['okTotal']); ?></span>&nbsp;团
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7" class="text-idt">
                                                        未成团数量：&nbsp;<span class="green"><?php echo ($groupNo['noTotal']); ?></span>&nbsp;团&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        未成团参与人数：&nbsp;<span class="green"><?php echo ($groupNo['noPeople']); ?></span>&nbsp;人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        平均每团参与人数：&nbsp;<span class="red font20"><?php echo ($groupNo['avgNoPeople']); ?></span>&nbsp;人
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7" class="text-idt">
                                                        参与总人数：&nbsp;<span class="green"><?php echo ($people['partake']); ?></span>&nbsp;人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        要求总人数：&nbsp;<span class="green"><?php echo ($people['require']); ?></span>&nbsp;人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        参与人数比：&nbsp;<span class="red font20"><?php echo ($people['ratio']); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;( 参与总人数 / 要求总人数 )
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th class="text-center">商品名</th>
                                                    <th class="text-center">成团所需人数</th>
                                                    <th class="text-center">平均未成团人数</th>
                                                    <th class="text-center">开团数量</th>
                                                    <th class="text-center">成团数量</th>
                                                    <th class="text-center">成团人数</th>
                                                    <th class="text-center">未成团人数</th>
                                                    <th class="text-center">成团比率</th>
                                                </tr>
                                                </thead>
                                                <tbody id="list_order_tby">
                                                    <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                            <td class="text-left"><?php echo ($val["groupbuying_name"]); ?></td>
                                                            <td class="text-center"><?php echo ($val["groupbuying_reqnums"]); ?>&nbsp;人</td>
                                                            <td class="text-center"><?php if($val["avgNoGroupPeople"] == ''): else: echo ($val["avgNoGroupPeople"]); ?>&nbsp;人<?php endif; ?></td>
                                                            <td><?php echo ($val["group"]); ?>&nbsp;团</td>
                                                            <td> <?php if($val["groupOk"] == ''): ?>0<?php else: echo ($val["groupOk"]); ?>&nbsp;团<?php endif; ?></td>
                                                            <td class="text-center"><?php echo ($val["okPeople"]); ?>&nbsp;人</td>
                                                            <td class="text-center"><?php if($val["noGroupPeople"] == ''): else: echo ($val["noGroupPeople"]); ?>&nbsp;人<?php endif; ?></td>
                                                            <td> <?php if($val["ratio"] == ''): else: echo ($val["ratio"]); ?>%<?php endif; ?></td>
