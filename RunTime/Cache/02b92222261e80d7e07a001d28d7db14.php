...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>O2O商户库存管理</span></li>
                                </ol>
    ...
    <td><?php echo ($item["o2o_goods_price"]); ?></td>
    <td>
        <a href="/index.php?m=Ostock&a=saveStock&id=<?php echo ($item["id"]); ?>&name=<?php echo ($item["product_name"]); ?>">修改信息</a>
    </td>
