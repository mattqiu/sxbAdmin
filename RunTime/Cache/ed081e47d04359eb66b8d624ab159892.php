                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>支付宝退款列表</span></li>
                                </ol>
                                ...
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <div class="main-box-header-act">
                                            <a href="/OrderRefund/alipayDoRefund" class="btn btn-primary mrg-b-lg" target="_blank">去支付宝退款</a>
                                        </div>
                                        <form action="/<?php echo (MODULE_NAME); ?>/alipayRefund" method="post" target="_self" role="form" id="order_search_form">


                                            <div class="row">
                                                <div class="form-group col-md-3" style="width:370px;">
                                                    <label for="batch_no" class="form-inline-label">退款批次：</label>
                                                    <input type="text" name="batch_no" class="form-control w150 form-inline-input-group" value="<?php echo ($post["batch_no"]); ?>" id="batch_no" />
                                                </div>
                                                <div class="form-group col-md-3" style="width:370px;">
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                <thead>
                                                <tr>
                                                    <th class="text-center">退款单id</th>
                                                    <th class="text-center">退款批次号</th>
                                                    <th class="text-center">原支付单号</th>
                                                    <th class="text-center">订单号</th>
                                                    <th class="text-center">退款时间</th>
                                                    <th class="text-center">退款支付单号</th>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td ><?php echo ($item["old_out_bill_no"]); ?></td>
                                                            <td><?php echo ($item["order_name"]); ?></td>
                                                            <td ><?php echo (date('Y-m-d H:i:s',$item["add_time"])); ?></td>
                                                            <td ><?php echo ($item["payment_id"]); ?></td>
                                                            <td>
                                                                <?php if($item["status"] == 'TRADE_HAS_CLOSED'): ?>退款关闭
                                                                    <?php elseif($item["status"] == 'SUCCESS'): ?>退款成功<?php endif; ?>
                                                            </td>
