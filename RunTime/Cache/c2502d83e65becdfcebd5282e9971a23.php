...
<div id="nav-col">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">首页</a></li>
                                    <li class="active"><span>O2O商家实例管理</span></li>
                                </ol>
                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">商户经度</th>
                                                    <th class="text-center">商户纬度</th>
                                                    <th class="text-center">商户名称</th>
                                                    <!--<th class="text-center">商户配送次数</th>-->
                                                    <th class="text-center">现在商户团实例ID</th>
                                                    <th class="text-center">配送时间段</th>
    ...
    <td><?php echo ($item["longitade"]); ?></td>
    <td><?php echo ($item["lat"]); ?></td>
    <td><?php echo ($item["merchant"]); ?></td>
    <!--<td><?php echo ($item["distribution_time_id"]); ?>次</td>-->
    <td><?php echo ($item["now_group_id"]); ?></td>
    <td><?php echo ($item["timeList"]); ?></td>
    <td>
        <a href="/index.php?m=Omerchantmsg&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Omerchantmsg&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
    </td>
