...
<div class="error">
   <div class="error1">    
        <img  src="__PUBLIC__/admin/images/error.gif" width="50" height="50" class="vm" />
        <span style="font-size: 16px;"><?php echo ($info["msg"]); ?>，</span>
        <span id="second"><?php echo ($info["second"]); ?></span>秒后跳转，
        <a href="<?php if(empty($info["url"])): ?>javascript:history.go(-1);<?php else: echo ($info["url"]); endif; ?>" id="url">返回上一页</a>
   </div>     
</div>
</div>
</body>
