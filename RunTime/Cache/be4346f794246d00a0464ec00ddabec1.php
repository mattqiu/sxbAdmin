...
<div id="nav-col">
                                    ...
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                <thead>
                                                <tr>
                                                    <th style="text-align:center;width:68px;">ID</th>
                                                    <th style="text-align:center;width:170px;">角色名称</th>
                                                    <th style="text-align:center;width:1068px;">角色权限</th>
                                                    <th style="text-align:center;width:668px;">角色描述</th>
                                                    <th style="text-align:center;width:68px;">状态</th>
                                                    <th style="text-align:center;width:168px;">操作</th>
                                                </tr>
                                                </thead>
                                                <tbody>
    ...
    <td style="text-align:left;">
    	<?php if(is_array($item["node"])): foreach($item["node"] as $key=>$qx): echo ($qx); ?>、<?php endforeach; endif; ?>
    </td>
    <td style="text-align:left;text-indent:40px;"><?php echo ($item["remark"]); ?></td>
    <td style="text-align:center;"><?php if($item["status"] == 1): ?>启用<?php else: ?>禁用<?php endif; ?></td>
    <td style="text-align:center;">
        <a href="/index.php?m=Role&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
        <a href="/index.php?m=Role&a=del&id=<?php echo ($item["id"]); ?>">删除</a>
        <a href="/index.php?m=Role&a=nodelist&id=<?php echo ($item["id"]); ?>">分配权限</a>
    </td>
