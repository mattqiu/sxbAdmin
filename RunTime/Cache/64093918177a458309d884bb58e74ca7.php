                            ...
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    <header class="main-box-header clearfix">
                                        ...
                                        <form action="/<?php echo (MODULE_NAME); ?>/orderDeliver" method="post" target="_self" role="form" id="order_search_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3 w370" >
                                                    ...
                                                    <select  id="site" class="form-control w150 text-center form-inline-input-group" name="site">
                                                        <option value="" <?php if($post["site"] == ''): ?>selected<?php endif; ?>>------全部------</option>
                                                        <?php if(is_array($site)): $i = 0; $__LIST__ = $site;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["distributor_id"]); ?>" <?php if($post["site"] == $vo['distributor_id']): ?>selected<?php endif; ?> >------<?php echo ($vo["short_name"]); ?>------</option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                ...
                                                <div class="form-group col-md-3 w370" >
                                                    ...
                                                    <select  id="send" class="form-control w150 text-center form-inline-input-group" name="send">
                                                        <option value="" <?php if($post["send"] == ''): ?>selected<?php endif; ?>>------全部------</option>
                                             ...
                                             <div class="row">
                                                <div class="form-group col-md-3" style="width:450px;" >
                                                    <label for="datepickerDateFrom" class="form-inline-label labels">发送邮件时间从：</label>
