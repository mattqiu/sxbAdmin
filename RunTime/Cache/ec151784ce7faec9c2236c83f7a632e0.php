        ...
        <div id="col-left-inner" class="col-left-nano-content">
            ...
            <div id="content-wrapper">
                ...
                <div class="md-content">
                    ...
                    <form action="/index.php?m=Node&a=save"  method="post" role="form" id="add_form">
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">节点名:</span>
                                    <input id="username" type="text" placeholder="请输入节点名" name="name" value="<?php echo ($vo["name"]); ?>" class="form-control col-xs-6"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="mname" id="username" placeholder="请输入控制器名" value="<?php echo ($vo["mname"]); ?>" class="form-control col-xs-5"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    <span class="label">操&nbsp;&nbsp;&nbsp;作:</span>
                                    <input type="text" name="aname" id="username" placeholder="请输入方法名" value="<?php echo ($vo["aname"]); ?>" class="form-control col-xs-3"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
