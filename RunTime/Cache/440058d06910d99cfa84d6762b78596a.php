                        ...
                        <div class="modal-body">
                            <div class="row">
                              <!--   <div class="form-group col-xs-3">
                                    <span class="label">id：<?php echo ($item["id"]); ?></span>
                                </div> -->

                                <div class="form-group col-xs-6" style="margin-right:30000px;">
                                    <span class="label">发货仓名</span>
                                    <input type="text" name="name" id="name" value="<?php echo ($item["name"]); ?>"class="form-control col-xs-6"  style="width:264px;"/>
                                </div>
                                <div class="form-group col-xs-6" style="margin-right:30000px;">
                                    <span class="label">发货仓号</span>
                                    <input type="text" name="jd_warehome_code"  value="<?php echo ($item["jd_warehome_code"]); ?>"class="form-control col-xs-6"  style="width:264px;"/>
                                </div>
                                <div class="form-group col-xs-6" style="margin-right:30000px;">
                                    <span class="label">字母名称</span>
                                    <input type="text" name="en_name"  value="<?php echo ($item["en_name"]); ?>"class="form-control col-xs-6"  style="width:264px;"/>
                                </div>
                                <div class="form-group col-xs-6" style="margin-right:30000px;">
                                    <span class="label">始发城市</span>
                                    <input type="text" name="source_city"  value="<?php echo ($item["source_city"]); ?>"class="form-control col-xs-6"  style="width:264px;"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <input type="text" name="supply_id_edit" class="form-control col-xs-2 modals_radio_select_input" id="supply_id_edit" value="<?php echo ($item["supply_id"]); ?>" style="width:154px;"/>
                                </div>
                            </div>
