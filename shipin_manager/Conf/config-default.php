...
$config['NO_STOCK_REFUND_MSG_TML_ID'] = 'kZAkE9r0XMJao1LCV3F5pX69dqDmvGNx0zhPhPyk3Og'; //缺货退款
$config['WX_SUBSCRIBE_MSG']  = '叔小白，拼起来！因咨询接待爆棚，叔小白可能无法及时回复，请您见谅；如您有问题咨询可以回复以下数字自助查看回复，若以下列表无法解决您的问题请留言，小白看到会第一时间回复您，给您造成不便敬请谅解！' . "\n" .
    '回复1   关于叔小白' . "\n" .
    '回复2   关于拼团与参团' . "\n" .
    '回复3   关于X元开团券' . "\n" .
    '回复4   关于团长特权' . "\n" .
...
$config['IS_MERGE_ORDER'] = false;
//微信公众号中间页自动跳转的团模板id
$config['WX_MIDDLE_PAGE_GROUP_TMP_ID'] = 0;
//微信公众号中间页自动跳转的已参团人数比例
$config['WX_MIDDLE_PAGE_LIMIT_RATIO'] = 0.8;
