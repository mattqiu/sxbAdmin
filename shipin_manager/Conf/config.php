...
$comm_config = array(
    ...
    'DB_PREFIX' => 'ttgy_',
    //正式服务器
    //'DB_NAME' => 'db_shipinmmm', 'DB_USER' => 'db_shipinmmm', 'DB_PWD' => 'Td$dl&D!#d_D',

    // 显示页面Trace信息
    //    'DEBUG_MODE' => false,
    'DEBUG_MODE' => true, 'TOKEN_ON' => true, // 是否开启令牌验证
...
$config = array(
    ...
    'APP_AUTOLOAD_PATH' => '@.TagLib', 'SESSION_AUTO_START' => true, 'USER_AUTH_ON' => true, 'USER_AUTH_TYPE' => 1, // 默认认证类型 1 登录认证 2 实时认证
    ...
    'DB_LIKE_FIELDS' => 'title|remark', 'SHOW_PAGE_TRACE' => 1, //显示调试信息
    //RBAC 相关表配置
