...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='P', $unit='mm', $format='JD_SHIPPING_V2', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
	...
	public function Header() {
		//默认会在页面头部生成 一条线，暂时取消， chrisying 15-12-25
		return;
	...
	public function Footer() {
		//默认会在页面底部生成 一条线，暂时取消， chrisying 15-12-25
		return;
		$cur_y = $this->y;
